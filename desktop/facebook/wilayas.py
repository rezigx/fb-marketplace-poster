"""
All 58 Algerian wilayas (provinces) with their Facebook Marketplace location details.

Each wilaya entry:
  - name:   English name (used in the app UI)
  - name_ar: Arabic name
  - code:    official wilaya code (01–58)

NOTE: Facebook Marketplace personal listings do not accept arbitrary coordinates
via a stable public API. The 58-wilaya effect is achieved by posting 58 listings
with human delays; regional reach is reinforced via title/location keywords.
"""
...
# Common marketplace categories (shown in the product builder dropdown).
CATEGORIES = [
    "Electronics",
    "Phones & Accessories",
    "Home & Garden",
...
def get_all_name_ar():
    """Convenience: list of Arabic names (optional UI use)."""
    return [w["name_ar"] for w in WILAYAS]
